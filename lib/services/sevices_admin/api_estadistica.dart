...
// URL base de tu API
const String _baseUrlAdmin = 'https://backendproyecto-production-4a8d.up.railway.app/api/admin';
const String _baseUrlJuegos = 'https://backendproyecto-production-4a8d.up.railway.app/api/juegos';
