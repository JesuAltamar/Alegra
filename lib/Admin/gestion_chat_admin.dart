...
class _GestionChatAdminState extends State<GestionChatAdmin> {
  ...
  Future<void> _cargarSentimientos() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost:5000/api/admin/chat/sentimientos?dias=30'),
      );
  ...
  Future<void> _cargarTemas() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost:5000/api/admin/chat/temas?limit=5'),
      );
  ...
  Future<void> _cargarTendencias() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost:5000/api/admin/chat/tendencias'),
      );
